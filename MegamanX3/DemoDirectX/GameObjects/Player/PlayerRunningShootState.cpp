...
PLayerRunningShootState::PLayerRunningShootState(PlayerData *playerData)
{
...
PLayerRunningShootState::~PLayerRunningShootState()
{
}
...
void PLayerRunningShootState::OnCollision(Entity *impactor, Entity::SideCollisions side, Entity::CollisionReturn data)
{
...
PlayerState::StateName PLayerRunningShootState::GetState()
{
	return PlayerState::RunnShoot;
}

PlayerState::StateName PLayerRunningShootState::GetStateHaveShoot()
{
	return PlayerState::RunnShoot;
}
