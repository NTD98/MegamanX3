...
public:
	...
	enum EntityTypes
	{
		...
		PosNotorbanger, HeadgunnerLeft, HeadgunnerRight, Helit, Genjibo, SlopingWall, ConveyorRight, ConveyorLeft, Stone5, Stone3,HeadGunner,BulletP,BulletCharge2,BulletCharge1,EnemyBullet,Static,Gunner
	};
